...
|  |      mean |           median |  
| ------ | ------- | ------ |  
| original (A) |     `r mean_steps_per_day` |     `r median_steps_per_day` |  
| imputed  (B) |     `r mean_steps_per_day_imputed` |     `r median_steps_per_day_imputed` |  
| diff (B - A) |     `r mean_steps_per_day_imputed - mean_steps_per_day` |     `r median_steps_per_day_imputed - median_steps_per_day` |  
